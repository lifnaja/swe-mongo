...
<div class="panel-heading"><b>สมัครสมาชิก</b></div>
 <div class="panel-body">
   <form action="">
    <div class="form-group">
       <label for="inputEmail3" class="control-label col-sm-2">รหัสสมาชิก</label>
       <div class="col-sm-2">
         <input type="text" class="form-control"  name="ID" placeholder="รหัสสมาชิก">
       </div></div><br><br>
     <div class="form-group">
